 ...
 * @brief
 */
public class SliceResult extends AbstractTaskFlowResult<Specifier<Void>> {
    ...
    public SliceResult( final String taskFlowType ) {

        super( taskFlowType );
    }


    public SliceResult( final String taskFlowType, final Specifier<Void> sliceSpecifier ) {
