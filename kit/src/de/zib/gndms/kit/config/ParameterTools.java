...
public final class ParameterTools {
    ...
    /** 
     * @return the String generated by {@link de.zib.gndms.kit.config.ParameterTools#append(StringBuilder, java.util.Map, java.util.regex.Pattern, boolean)} 
     */
    ...
    /**
     * Invokes {@link de.zib.gndms.kit.config.ParameterTools#asString(java.util.Map, java.util.regex.Pattern, boolean)}
     * with {@code addNewlines=false} so that no new line follows after a semicolon
     */
