...
abstract class DirectoryAux {
     ...
     */
    public abstract boolean changeOwner( String uid, String path );

    /**
     * Deletes the given directory.
     *
     * @param uid The owner of the directory
     * @param pth The Path.
     */
    public abstract boolean deleteDirectory( String owner, String pth );
