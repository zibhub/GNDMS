...
define 'gndms' do
  ...
  #  end
    ...
    define 'stuff', :layout => dmsLayout('stuff', 'gndms-stuff') do
       ...
       compile.with  GOOGLE_COLLECTIONS, JETBRAINS_ANNOTATIONS, JSON, SPRING, SLF4J
    ...
    define 'kit', :layout => dmsLayout('kit', 'gndms-kit') do
      compile.with JETTY, GROOVY, GOOGLE_COLLECTIONS, COMMONS_FILEUPLOAD, COMMONS_CODEC, project('common'), project('stuff'), project('model'), project('neomodel'), JETBRAINS_ANNOTATIONS, GT4_LOG, GT4_COG, GT4_AXIS, GT4_SEC, GT4_XML, JODA_TIME, ARGS4J, INJECT, GT4_SERVLET, COMMONS_LANG, OPENJPA, SLF4J, JSON, SPRING, JNA
      compile
      test.compile
      test.using :testng
      package :jar
