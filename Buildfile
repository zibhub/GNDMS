...
JAVAX_MAIL='javax.mail:mail:jar:1.4.5'
...
define 'gndms' do
    ...
    define 'logic', :layout => dmsLayout('logic', 'gndms-logic') do
       compile.with JETBRAINS_ANNOTATIONS, project('kit'), project('common'), project('stuff'), project('model'), project('neomodel'), project('voldmodel'), JODA_TIME, GOOGLE_COLLECTIONS, INJECT, DB_DERBY, GT4_LOG, GT4_COG, GT4_SEC, GT4_XML, COMMONS_LANG, OPENJPA, SLF4J, SPRING, SPRING_SECURITY
       compile
       package :jar
    end
    ...
    define 'gndmc-rest', :layout => dmsLayout('gndmc-rest', 'gndms-gndmc-rest') do
        compile.with project('stuff'), project('common'), SPRING, ARGS4J, JODA_TIME, SLF4J, COMMONS_LOGGING, XSTREAM, XSTREAM_DEPS, JSON, ASPECTJ, TESTNG, INJECT
    ...
    define 'gndms', :layout => dmsLayout('gndms', 'gndms-rest') do
        ...
        compile.with project('stuff'), project('voldmodel'),project('model'), SPRING, SPRING_SECURITY, SLF4J, SERVLET
