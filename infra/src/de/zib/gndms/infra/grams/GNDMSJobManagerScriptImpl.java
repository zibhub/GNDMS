 ...
 */
public class GNDMSJobManagerScriptImpl implements GNDMSJobManagerScript {
    ...
    public GNDMSJobManagerScriptImpl(
            String username,
        ...
        throws                              IOException
    {
        ...
        this.command = ScriptCommandEnumeration.submit;
    ...
    static Logger logger = LoggerFactory.getLogger( GNDMSJobManagerScriptImpl.class );
