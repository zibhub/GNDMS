 ...
 */
public class GridResourceModelHandler<M extends GridEntity & GridResourceItf, H extends GNDMServiceHome, R extends ReloadablePersistentResource<M, H>> extends GridEntityModelHandler<M, H, R> {
