...
cp="$GNDMS_SOURCE/taskflows/staging/lib/client/staging-client-${VERSION}.jar:$cp"
...
cp="$GNDMS_SOURCE/taskflows/DMSStaging/client/dmsStaging-client/production:$cp"

props=( )

exec java -cp $cp ${props[@]} de.zib.gndms.taskflows.dmsstaging.client.tools.DmsStageInExample ${args[@]} "$@"
