...
cp="$GNDMS_SOURCE/taskflows/fileTransfer/lib/client/transfer-client-${VERSION}.jar:$cp"
...
cp="$HOME/.m2/repository/org/apache/openjpa/openjpa-all/2.2.2/openjpa-all-2.2.2.jar:$cp"
