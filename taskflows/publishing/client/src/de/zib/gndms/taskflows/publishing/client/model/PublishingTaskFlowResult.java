 ...
 */
public class PublishingTaskFlowResult implements TaskResult< Void > {

    private static final long serialVersionUID = -1055909115754217359L;

    public PublishingTaskFlowResult() {
    }
