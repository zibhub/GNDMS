...
cp="$GNDMS_SOURCE/taskflows/publishing/client/publishing-client/production:$cp"

props=( )

exec java -cp $cp ${props[@]} de.zib.gndms.taskflows.publishing.client.tools.PublishingExample ${args[@]} "$@"
