 ...
 */
public abstract class OfferClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected OfferPortType portType;
	...
	public OfferClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public OfferClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	private OfferPortType createPortType() throws RemoteException {

		OfferServiceAddressingLocator locator = new OfferServiceAddressingLocator();
		...
		OfferPortType port = null;
		try {
			port = locator.getOfferPortTypePort(getEndpointReference());
		} catch (Exception e) {
