 ...
 * 
 */
public class OfferAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://GORFX.gndms.zib.de/GORFX/Offer";
	...
	public static void authorizeAccept() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("accept")){
			try{
				authorizeAccept();
				return true;
			} catch (Exception e){
