 ...
 * 
 */
public abstract class ORQResourceBase extends ReflectionResource implements Resource
                                                  ,TopicListAccessor
                                                  ,SecureResource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(ORQResourceBase.class);

	private ORQResourceConfiguration configuration;
	...
	public void setTerminationTime(Calendar time) {	
		Topic terminationTopic = ((Topic)getResourcePropertySet().get(ORQConstants.TERMINATIONTIME));
