 ...
 * 
 */
public class GORFXAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://GORFX.gndms.zib.de/GORFX";
	
	
	public GORFXAuthorization() {
	}
	...
	public static void authorizeCreateOfferRequest() throws RemoteException {
		
		
	}
					
	public static void authorizeGetSupportedOfferTypes() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("createOfferRequest")){
			try{
				authorizeCreateOfferRequest();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
