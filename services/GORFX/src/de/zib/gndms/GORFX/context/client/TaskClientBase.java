 ...
 */
public abstract class TaskClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected TaskPortType portType;
	...
	public TaskClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public TaskClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	private TaskPortType createPortType() throws RemoteException {

		TaskServiceAddressingLocator locator = new TaskServiceAddressingLocator();
		...
		TaskPortType port = null;
		try {
			port = locator.getTaskPortTypePort(getEndpointReference());
		} catch (Exception e) {
