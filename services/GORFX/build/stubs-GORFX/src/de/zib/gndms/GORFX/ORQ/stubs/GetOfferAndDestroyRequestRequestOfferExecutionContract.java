/**
 * GetOfferAndDestroyRequestRequestOfferExecutionContract.java
 *
...
public class GetOfferAndDestroyRequestRequestOfferExecutionContract  implements java.io.Serializable {
    private types.OfferExecutionContractT offerExecutionContract;

    public GetOfferAndDestroyRequestRequestOfferExecutionContract() {
    }
    ...
    /**
     * Gets the offerExecutionContract value for this GetOfferAndDestroyRequestRequestOfferExecutionContract.
     * 
    ...
    /**
     * Sets the offerExecutionContract value for this GetOfferAndDestroyRequestRequestOfferExecutionContract.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetOfferAndDestroyRequestRequestOfferExecutionContract)) return false;
        GetOfferAndDestroyRequestRequestOfferExecutionContract other = (GetOfferAndDestroyRequestRequestOfferExecutionContract) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetOfferAndDestroyRequestRequestOfferExecutionContract.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/ORQ", ">>GetOfferAndDestroyRequestRequest>offerExecutionContract"));
