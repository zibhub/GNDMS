/**
 * ORQServiceAddressingLocator.java
 *
...
public class ORQServiceAddressingLocator extends de.zib.gndms.GORFX.ORQ.stubs.service.ORQServiceLocator implements de.zib.gndms.GORFX.ORQ.stubs.service.ORQServiceAddressing {
    public de.zib.gndms.GORFX.ORQ.stubs.ORQPortType getORQPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	de.zib.gndms.GORFX.ORQ.stubs.ORQPortType _stub = getORQPortTypePort(endpoint);
	if (_stub != null) {
