/**
 * GetOfferAndDestroyRequestResponse.java
 *
...
public class GetOfferAndDestroyRequestResponse  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public GetOfferAndDestroyRequestResponse() {
    }
    ...
    /**
     * Gets the endpointReference value for this GetOfferAndDestroyRequestResponse.
     * 
    ...
    /**
     * Sets the endpointReference value for this GetOfferAndDestroyRequestResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetOfferAndDestroyRequestResponse)) return false;
        GetOfferAndDestroyRequestResponse other = (GetOfferAndDestroyRequestResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetOfferAndDestroyRequestResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/ORQ", ">GetOfferAndDestroyRequestResponse"));
