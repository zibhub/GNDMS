...
package de.zib.gndms.GORFX.offer.stubs.types;

public class OfferReference  implements java.io.Serializable {
    ...
    /**
     * Gets the endpointReference value for this OfferReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this OfferReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OfferReference)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OfferReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Offer/types", ">OfferReference"));
