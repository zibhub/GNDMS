...
package de.zib.gndms.GORFX.context.stubs.types;

public class TaskReference  implements java.io.Serializable {
    ...
    /**
     * Gets the endpointReference value for this TaskReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this TaskReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TaskReference)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TaskReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Context/types", ">TaskReference"));
