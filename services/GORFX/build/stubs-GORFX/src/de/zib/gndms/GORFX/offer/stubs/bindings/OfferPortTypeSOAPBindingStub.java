/**
 * OfferPortTypeSOAPBindingStub.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Feb 27, 2008 (08:34:14 CST) WSDL2Java emitter.
 */

package de.zib.gndms.GORFX.offer.stubs.bindings;

public class OfferPortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements de.zib.gndms.GORFX.offer.stubs.OfferPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("Accept");
        oper.addParameter(new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Offer", "AcceptRequest"), new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Offer", ">AcceptRequest"), de.zib.gndms.GORFX.offer.stubs.AcceptRequest.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Offer", ">AcceptResponse"));
        oper.setReturnClass(de.zib.gndms.GORFX.offer.stubs.AcceptResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Offer", "AcceptResponse"));
    ...
    public OfferPortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public OfferPortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public OfferPortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings0() {
            ...
            qName = new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Offer", ">AcceptResponse");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.GORFX.offer.stubs.AcceptResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Offer", ">AcceptRequest");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.GORFX.offer.stubs.AcceptRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings1() {
            ...
            qName = new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/Offer", ">OfferResourceProperties");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.GORFX.offer.stubs.OfferResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public de.zib.gndms.GORFX.offer.stubs.AcceptResponse accept(de.zib.gndms.GORFX.offer.stubs.AcceptRequest parameters) throws java.rmi.RemoteException, de.zib.gndms.GORFX.ORQ.stubs.types.PermissionDenied {
        ...
        _call.setSOAPActionURI("http://GORFX.gndms.zib.de/GORFX/Offer/AcceptRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "Accept"));
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (de.zib.gndms.GORFX.offer.stubs.AcceptResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.zib.gndms.GORFX.offer.stubs.AcceptResponse) org.apache.axis.utils.JavaUtils.convert(_resp, de.zib.gndms.GORFX.offer.stubs.AcceptResponse.class);
            }
        }
    }
