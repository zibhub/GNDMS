/**
 * GORFXServiceAddressingLocator.java
 *
...
public class GORFXServiceAddressingLocator extends de.zib.gndms.GORFX.stubs.service.GORFXServiceLocator implements de.zib.gndms.GORFX.stubs.service.GORFXServiceAddressing {
    public de.zib.gndms.GORFX.stubs.GORFXPortType getGORFXPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	de.zib.gndms.GORFX.stubs.GORFXPortType _stub = getGORFXPortTypePort(endpoint);
	if (_stub != null) {
