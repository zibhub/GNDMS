...
package de.zib.gndms.GORFX.stubs.types;

public class GORFXReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public GORFXReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this GORFXReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this GORFXReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GORFXReference)) return false;
        GORFXReference other = (GORFXReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GORFXReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://GORFX.gndms.zib.de/GORFX/types", ">GORFXReference"));
