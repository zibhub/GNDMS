...
public class ProviderStageInResultT  extends types.DynamicOfferDataSeqT  implements java.io.Serializable {
    public ProviderStageInResultT() {
    }

    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProviderStageInResultT.class, false);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gndms.zib.de/c3grid/types", "ProviderStageInResultT"));
