 ...
 */
public abstract class SliceClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected SlicePortType portType;
	...
	public SliceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public SliceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	private SlicePortType createPortType() throws RemoteException {

		SliceServiceAddressingLocator locator = new SliceServiceAddressingLocator();
		...
		SlicePortType port = null;
		try {
			port = locator.getSlicePortTypePort(getEndpointReference());
		} catch (Exception e) {
