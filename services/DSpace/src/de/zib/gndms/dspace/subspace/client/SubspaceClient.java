...
public class SubspaceClient extends SubspaceClientBase implements SubspaceI {	
    ...
    public SliceClient createSliceInSubspace( String sliceKindURI, Calendar terminationTime,
                                              StorageSize totalStorageSize ) throws URI.MalformedURIException, RemoteException, OutOfSpace {
        ...
        return createSliceInSubspace( scs );
    }


    public SliceClient createSliceInSubspace( SliceCreationSpecifier specifier ) throws RemoteException, UnknownOrInvalidSliceKind, OutOfSpace, URI.MalformedURIException {
