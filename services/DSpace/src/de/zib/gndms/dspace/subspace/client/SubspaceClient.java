...
public class SubspaceClient extends SubspaceClientBase implements SubspaceI {	
    ...
    public StorageSize getAvailableStorageSize( ) throws DeserializationException, RemoteException {

        return getStorageSizeX( SubspaceConstants.AVAILABLESTORAGESIZE );
    }
    

    public StorageSize getTotalStorageSize( ) throws DeserializationException, RemoteException {

        return getStorageSizeX( SubspaceConstants.TOTALSTORAGESIZE );
    }

    
    private StorageSize getStorageSizeX( QName sizeKind ) throws RemoteException, DeserializationException {
