 ...
 * 
 */
public class SubspaceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://dspace.gndms.zib.de/dspace/Subspace";
	
	
	public SubspaceAuthorization() {
	}
	...
	public static void authorizeCreateSlice() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("listCreatableSliceKinds")){
			try{
				authorizeListCreatableSliceKinds();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
