...
public class TransformSliceResponse  implements java.io.Serializable {
    private de.zib.gndms.dspace.slice.stubs.types.SliceReference sliceReference;

    public TransformSliceResponse() {
    }
    ...
    /**
     * Gets the sliceReference value for this TransformSliceResponse.
     * 
    ...
    /**
     * Sets the sliceReference value for this TransformSliceResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TransformSliceResponse)) return false;
        TransformSliceResponse other = (TransformSliceResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TransformSliceResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", ">TransformSliceResponse"));
