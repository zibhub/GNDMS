/**
 * SubspaceReference.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Feb 27, 2008 (08:34:14 CST) WSDL2Java emitter.
 */

package de.zib.gndms.dspace.subspace.stubs.types;

public class SubspaceReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public SubspaceReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this SubspaceReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this SubspaceReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SubspaceReference)) return false;
        SubspaceReference other = (SubspaceReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SubspaceReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Subspace/types", ">SubspaceReference"));
