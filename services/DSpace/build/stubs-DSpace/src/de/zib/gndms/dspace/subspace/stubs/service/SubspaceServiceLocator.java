...
package de.zib.gndms.dspace.subspace.stubs.service;

public class SubspaceServiceLocator extends org.apache.axis.client.Service implements de.zib.gndms.dspace.subspace.stubs.service.SubspaceService {
    ...
    public de.zib.gndms.dspace.subspace.stubs.SubspacePortType getSubspacePortTypePort() throws javax.xml.rpc.ServiceException {
    ...
    public de.zib.gndms.dspace.subspace.stubs.SubspacePortType getSubspacePortTypePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.zib.gndms.dspace.subspace.stubs.bindings.SubspacePortTypeSOAPBindingStub _stub = new de.zib.gndms.dspace.subspace.stubs.bindings.SubspacePortTypeSOAPBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.zib.gndms.dspace.subspace.stubs.SubspacePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                de.zib.gndms.dspace.subspace.stubs.bindings.SubspacePortTypeSOAPBindingStub _stub = new de.zib.gndms.dspace.subspace.stubs.bindings.SubspacePortTypeSOAPBindingStub(new java.net.URL(SubspacePortTypePort_address), this);
                _stub.setPortName(getSubspacePortTypePortWSDDServiceName());
                return _stub;
            }
        }
