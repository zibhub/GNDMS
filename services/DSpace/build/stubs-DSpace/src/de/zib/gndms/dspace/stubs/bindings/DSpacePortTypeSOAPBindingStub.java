...
public class DSpacePortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements de.zib.gndms.dspace.stubs.DSpacePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("GetSubspaceByName");
        oper.addParameter(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace", "GetSubspaceByNameRequest"), new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace", ">GetSubspaceByNameRequest"), de.zib.gndms.dspace.stubs.GetSubspaceByNameRequest.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace", ">GetSubspaceByNameResponse"));
        oper.setReturnClass(de.zib.gndms.dspace.stubs.GetSubspaceByNameResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace", "GetSubspaceByNameResponse"));
    ...
    public DSpacePortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace", ">GetSubspaceByNameRequest");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.dspace.stubs.GetSubspaceByNameRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace", ">GetSubspaceByNameResponse");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.dspace.stubs.GetSubspaceByNameResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public de.zib.gndms.dspace.stubs.GetSubspaceByNameResponse getSubspaceByName(de.zib.gndms.dspace.stubs.GetSubspaceByNameRequest parameters) throws java.rmi.RemoteException, de.zib.gndms.dspace.stubs.types.UnknownSubspace {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("http://dspace.gndms.zib.de/DSpace/GetSubspaceByNameRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "GetSubspaceByName"));
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (de.zib.gndms.dspace.stubs.GetSubspaceByNameResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.zib.gndms.dspace.stubs.GetSubspaceByNameResponse) org.apache.axis.utils.JavaUtils.convert(_resp, de.zib.gndms.dspace.stubs.GetSubspaceByNameResponse.class);
            }
        }
    }
    ...
    public de.zib.gndms.dspace.stubs.ListPublicSubspacesResponse listPublicSubspaces(de.zib.gndms.dspace.stubs.ListPublicSubspacesRequest parameters) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://dspace.gndms.zib.de/DSpace/ListPublicSubspacesRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
