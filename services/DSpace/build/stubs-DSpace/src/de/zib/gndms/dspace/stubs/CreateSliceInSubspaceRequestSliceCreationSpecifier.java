/**
 * CreateSliceInSubspaceRequestSliceCreationSpecifier.java
 *
...
public class CreateSliceInSubspaceRequestSliceCreationSpecifier  implements java.io.Serializable {
    private types.SliceCreationSpecifier sliceCreationSpecifier;

    public CreateSliceInSubspaceRequestSliceCreationSpecifier() {
    }
    ...
    /**
     * Gets the sliceCreationSpecifier value for this CreateSliceInSubspaceRequestSliceCreationSpecifier.
     * 
    ...
    /**
     * Sets the sliceCreationSpecifier value for this CreateSliceInSubspaceRequestSliceCreationSpecifier.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateSliceInSubspaceRequestSliceCreationSpecifier)) return false;
        CreateSliceInSubspaceRequestSliceCreationSpecifier other = (CreateSliceInSubspaceRequestSliceCreationSpecifier) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateSliceInSubspaceRequestSliceCreationSpecifier.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace", ">>CreateSliceInSubspaceRequest>sliceCreationSpecifier"));
