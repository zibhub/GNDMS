...
public class ListPublicSubspacesResponse  implements java.io.Serializable {
    ...
    public de.zib.gndms.dspace.subpace.stubs.types.SubspaceReference getSubspaceReference(int i) {
        return this.subspaceReference[i];
    }

    public void setSubspaceReference(int i, de.zib.gndms.dspace.subpace.stubs.types.SubspaceReference _value) {
