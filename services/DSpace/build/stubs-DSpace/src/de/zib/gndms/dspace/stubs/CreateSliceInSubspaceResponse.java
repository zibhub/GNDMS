/**
 * CreateSliceInSubspaceResponse.java
 *
...
public class CreateSliceInSubspaceResponse  implements java.io.Serializable {
    private de.zib.gndms.dspace.slice.stubs.types.SliceReference sliceReference;

    public CreateSliceInSubspaceResponse() {
    }
    ...
    /**
     * Gets the sliceReference value for this CreateSliceInSubspaceResponse.
     * 
    ...
    /**
     * Sets the sliceReference value for this CreateSliceInSubspaceResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateSliceInSubspaceResponse)) return false;
        CreateSliceInSubspaceResponse other = (CreateSliceInSubspaceResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateSliceInSubspaceResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace", ">CreateSliceInSubspaceResponse"));
