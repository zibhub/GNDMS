/**
 * SliceServiceAddressingLocator.java
 *
...
public class SliceServiceAddressingLocator extends de.zib.gndms.dspace.slice.stubs.service.SliceServiceLocator implements de.zib.gndms.dspace.slice.stubs.service.SliceServiceAddressing {
    public de.zib.gndms.dspace.slice.stubs.SlicePortType getSlicePortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	de.zib.gndms.dspace.slice.stubs.SlicePortType _stub = getSlicePortTypePort(endpoint);
	if (_stub != null) {
