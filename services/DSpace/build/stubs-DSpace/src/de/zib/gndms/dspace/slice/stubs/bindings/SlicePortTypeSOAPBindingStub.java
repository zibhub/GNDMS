...
public class SlicePortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements de.zib.gndms.dspace.slice.stubs.SlicePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("TransformSlice");
        oper.addParameter(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", "TransformSliceRequest"), new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", ">TransformSliceRequest"), de.zib.gndms.dspace.slice.stubs.TransformSliceRequest.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", ">TransformSliceResponse"));
        oper.setReturnClass(de.zib.gndms.dspace.slice.stubs.TransformSliceResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", "TransformSliceResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice/types", "OutOfSpace"),
                      "de.zib.gndms.dspace.slice.stubs.types.OutOfSpace",
                      new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice/types", "OutOfSpace"), 
                      true
                     ));
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice/types", "UnsupportedOrInvalidSliceKind"),
                      "de.zib.gndms.dspace.slice.stubs.types.UnsupportedOrInvalidSliceKind",
                      new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice/types", "UnsupportedOrInvalidSliceKind"), 
                      true
                     ));
        _operations[0] = oper;
        ...
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice/types", "UnknownSubspace"),
                      "de.zib.gndms.dspace.slice.stubs.types.UnknownSubspace",
                      new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice/types", "UnknownSubspace"), 
                      true
                     ));
        oper.addFault(new org.apache.axis.description.FaultDesc(
    ...
    public SlicePortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", ">>TransformSliceRequest>sliceKind");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.dspace.slice.stubs.TransformSliceRequestSliceKind.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", ">TransformSliceRequest");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.dspace.slice.stubs.TransformSliceRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", ">TransformSliceResponse");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.dspace.slice.stubs.TransformSliceResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://dspace.gndms.zib.de/DSpace/Slice", ">>TransformSliceToRequest>sliceKind");
            cachedSerQNames.add(qName);
            cls = de.zib.gndms.dspace.slice.stubs.TransformSliceToRequestSliceKind.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public de.zib.gndms.dspace.slice.stubs.TransformSliceResponse transformSlice(de.zib.gndms.dspace.slice.stubs.TransformSliceRequest parameters) throws java.rmi.RemoteException, de.zib.gndms.dspace.slice.stubs.types.OutOfSpace, de.zib.gndms.dspace.slice.stubs.types.UnsupportedOrInvalidSliceKind {
        ...
        _call.setSOAPActionURI("http://dspace.gndms.zib.de/DSpace/Slice/TransformSliceRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "TransformSlice"));
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (de.zib.gndms.dspace.slice.stubs.TransformSliceResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (de.zib.gndms.dspace.slice.stubs.TransformSliceResponse) org.apache.axis.utils.JavaUtils.convert(_resp, de.zib.gndms.dspace.slice.stubs.TransformSliceResponse.class);
            }
        }
    }
    ...
    public de.zib.gndms.dspace.slice.stubs.TransformSliceToResponse transformSliceTo(de.zib.gndms.dspace.slice.stubs.TransformSliceToRequest parameters) throws java.rmi.RemoteException, de.zib.gndms.dspace.slice.stubs.types.UnknownSubspace, de.zib.gndms.dspace.slice.stubs.types.OutOfSpace, de.zib.gndms.dspace.slice.stubs.types.UnsupportedOrInvalidSliceKind {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://dspace.gndms.zib.de/DSpace/Slice/TransformSliceToRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
