 ...
 * 
 */
public abstract class WHORFXResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(WHORFXResourceBase.class);

	private WHORFXResourceConfiguration configuration;
	...
	public WHORFXResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (WHORFXResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
