/**
 * WHORFXServiceAddressingLocator.java
 *
...
public class WHORFXServiceAddressingLocator extends de.zib.gndms.stubs.service.WHORFXServiceLocator implements de.zib.gndms.stubs.service.WHORFXServiceAddressing {
    public de.zib.gndms.stubs.WHORFXPortType getWHORFXPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	de.zib.gndms.stubs.WHORFXPortType _stub = getWHORFXPortTypePort(endpoint);
	if (_stub != null) {
