 ...
 * 
 */
public class LofiSetAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://lofis.gndms.zib.de/LOFIS/LofiSet";
	
	
	public LofiSetAuthorization() {
	}
