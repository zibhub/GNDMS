 ...
 * 
 */
public abstract class LOFISResourceBase extends ReflectionResource implements Resource
                                                  ,PersistenceCallback
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(LOFISResourceBase.class);

	private LOFISResourceConfiguration configuration;
    ...
    public LOFISResourceBase() {
        try {
            resourcePropertyPersistenceHelper = new gov.nih.nci.cagrid.introduce.servicetools.XmlPersistenceHelper(LOFISResourceProperties.class,LOFISConfiguration.getConfiguration());
	...
	public LOFISResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (LOFISResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
    ...
    public void load(ResourceKey resourceKey) throws ResourceException, NoSuchResourceException, InvalidResourceKeyException {
	  beingLoaded = true;
       ...
       LOFISResourceProperties props = (LOFISResourceProperties)resourcePropertyPersistenceHelper.load(LOFISResourceProperties.class, id);
       this.initialize(props, LOFISConstants.RESOURCE_PROPERTY_SET, id);
