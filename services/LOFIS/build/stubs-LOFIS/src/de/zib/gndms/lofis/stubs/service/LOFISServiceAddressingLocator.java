/**
 * LOFISServiceAddressingLocator.java
 *
...
public class LOFISServiceAddressingLocator extends de.zib.gndms.lofis.stubs.service.LOFISServiceLocator implements de.zib.gndms.lofis.stubs.service.LOFISServiceAddressing {
    public de.zib.gndms.lofis.stubs.LOFISPortType getLOFISPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	de.zib.gndms.lofis.stubs.LOFISPortType _stub = getLOFISPortTypePort(endpoint);
	if (_stub != null) {
