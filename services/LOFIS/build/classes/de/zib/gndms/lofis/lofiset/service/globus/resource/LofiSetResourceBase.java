 ...
 * 
 */
public abstract class LofiSetResourceBase extends ReflectionResource implements Resource
                                                  ,PersistenceCallback
                                                  ,TopicListAccessor
                                                  ,SecureResource
                                                  ,RemoveCallback
	...
	static final Log logger = LogFactory.getLog(LofiSetResourceBase.class);

	private LofiSetResourceConfiguration configuration;
    ...
    public LofiSetResourceBase() {
        try {
            resourcePropertyPersistenceHelper = new gov.nih.nci.cagrid.introduce.servicetools.XmlPersistenceHelper(LofiSetResourceProperties.class,LOFISConfiguration.getConfiguration());
            resourcePersistenceHelper = new FilePersistenceHelper(this.getClass(),LOFISConfiguration.getConfiguration(),".resource");
        } catch (Exception ex) {
	...
	public void setTerminationTime(Calendar time) {	
		Topic terminationTopic = ((Topic)getResourcePropertySet().get(LofiSetConstants.TERMINATIONTIME));
	...
	public LofiSetResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (LofiSetResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
    ...
    public void load(ResourceKey resourceKey) throws ResourceException, NoSuchResourceException, InvalidResourceKeyException {
	  beingLoaded = true;
	   ...
	   LofiSetResourceProperties props = (LofiSetResourceProperties)resourcePropertyPersistenceHelper.load(LofiSetResourceProperties.class, resourceKey.getValue());
       this.initialize(props, LofiSetConstants.RESOURCE_PROPERTY_SET, resourceKey.getValue());
